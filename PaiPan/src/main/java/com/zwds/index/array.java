...
//                 紫微1-天机1-太阳1-武曲1-天同1廉贞1天府1太阴1贪狼1-巨门1天相1天梁1-七杀1破军1文昌1-文曲--禄存--擎羊--陀罗--火星--铃星--左辅--右弼
    ...
    public String getShiXing(int gong, int niangan) {
        String[][] arr = {
                {"戌","酉","申","未","午","巳","辰","卯","寅","丑","子","亥"},
                {"辰","巳","午","未","申","酉","戌","亥","子","丑","寅","卯"},
                {"亥","子","丑","寅","卯","辰","巳","午","未","申","酉","戌"},
    ...
    public String getDouJun(int gong, int niangan) {
        String[][] arr = {
                {"子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"},
                {"亥","子","丑","寅","卯","辰","巳","午","未","申","酉","戌"},
                {"戌","亥","子","丑","寅","卯","辰","巳","午","未","申","酉"},
    ...
    public String[] getBoShi(int month,int or) {
    ...
    public String getChangSheng(int ii,int jj, int or) {
        String[][] arr1 = {
                {"申","亥","巳","申","寅"},
                {"酉","子","午","酉","卯"},
                {"戌","丑","未","戌","辰"},
    ...
    public String[] getXunKong(int niangan,String dz) {
        String[][] arr = {
                {"子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"},
                {"戌","亥","子","丑","寅","卯","辰","巳","午","未","申","酉"},
                {"申","酉","戌","亥","子","丑","寅","卯","辰","巳","午","未"},
    ...
    public Map<String, String> getJieKong(int tgIndex) {
        String[][] arr = {
                {"申","午","辰","寅","子"},
                {"酉","未","巳","卯","丑"}
        };
        Map<String, String> startMap = new HashMap<String, String>();
        startMap.put(arr[0][tgIndex],"截空");
        startMap.put(arr[1][tgIndex],"截空");
        return startMap;
    }

    public String[] getSanTaiBaZuoIndex(int month) {
