...
import com.zwds.serviceImpl.dateUtil;
...
//    }
    ...
    public static String getLunar(String year, String month, String day) {
        ...
        s = "农历 " + "," + Animals[sy] + "," + cYear(getYear()) + "," + " ";

        s += (getIsLeap() ? "闰" : "") + monthNong[getMonth()] + ","
    ...
    public String jiSuan(int x){
//        tianGanDiZhi input2=new tianGanDiZhi();
        int q=0;
        int a=(x-4)%10;//求天干
        int b=(x-4)%12;//求地支
        ...
        array[c]=tianGan[a]+"-"+diZhi[b];


        return array[c];//返回引用String类型
